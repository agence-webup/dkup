...
test('Period extraction from filename', () => {
  ...
  expect(manager.extractPeriodFromFilename('my_project-instant-20200415_181502.tar.gz')).toBe('instant')
  expect(manager.extractPeriodFromFilename('my-project-instant-20200415_181502.tar.gz')).toBe('instant')
